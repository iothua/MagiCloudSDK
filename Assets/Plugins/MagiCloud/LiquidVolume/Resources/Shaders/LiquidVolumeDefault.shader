Shader "LiquidVolume/Default" {
	...
	// PBS Liquid ====================================================================================================================================
		...
		CGPROGRAM
		#pragma vertex vert
		#pragma surface surf WrappedSpecular alpha nolightmap nofog noinstancing
		#pragma fragmentoption ARB_precision_hint_fastest
		#pragma target 3.0
		#pragma multi_compile __ LIQUID_VOLUME_DEPTH_AWARE
		...
		CGPROGRAM
		#pragma surface surf Standard alpha nolightmap nofog noinstancing 
		#pragma target 3.0
