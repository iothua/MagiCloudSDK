...
{
    public class RijndaelCryptograph : IDecryptor, IEncryptor
    {
        ...
        {
#if NETFX_CORE
            IBuffer bufferDecrypt = CryptographicEngine.Decrypt(cryptographicKey, data.AsBuffer(), iv.AsBuffer());
        ...
        {
#if NETFX_CORE
            IBuffer bufferEncrypt = CryptographicEngine.Encrypt(cryptographicKey, data.AsBuffer(), iv.AsBuffer());
        ...
        public virtual Stream Encrypt(Stream input)
        {
            ...
            throw new NotImplementedException();
#else
            return new CryptoStream(input, this.rijndael.CreateEncryptor(this.key, this.iv), CryptoStreamMode.Write);
#endif
        }
    }
}
