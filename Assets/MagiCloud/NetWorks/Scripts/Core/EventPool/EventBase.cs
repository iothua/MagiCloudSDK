...
namespace MagiCloud.NetWorks
{
    ...
    public delegate void ReceiveDelegate(int sender,IMessage proto);
    ...
    public class EventBase
    {
        ...
        public virtual void Init(IMessageDistribution messageDistribution)
        {
        ...
        public virtual void Send<T>(IConnect connection,T info) where T : IMessage
        {
