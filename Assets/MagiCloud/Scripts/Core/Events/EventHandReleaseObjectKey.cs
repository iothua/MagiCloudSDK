...
{
    public static class EventHandReleaseObjectKey
    {
        ...
        public static void AddReleaseObject(this GameObject key, Action<int> action, ExecutionPriority priority = ExecutionPriority.Mid)
        {
        ...
        /// <param name="key">自身Object</param>
        /// <param name="action">委托</param>
        public static void RemoveReleaseObject(this GameObject key, Action<int> action)
        {
        ...
        public static void RemoveReleaseObjectAll(this GameObject key)
        {
            RemoveListener(key);
        }
    }
