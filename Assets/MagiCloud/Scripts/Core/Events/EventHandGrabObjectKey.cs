...
{
    public static class EventHandGrabObjectKey
    {
        ...
        /// <param name="key">自身Object</param>
        /// <param name="action">委托</param>
        public static void RemoveGrabObject(this GameObject key, Action<int> action)
        {
        ...
        public static void RemoveGrabObjectAll(this GameObject key)
        {
            RemoveListener(key);
        }
