...
namespace MagiCloud
{
    ...
    /// 针对一个手势的处理
    /// </summary>
    public class MOperate :OperateBase
    {
        /// <summary>
        /// 与之关联的输入端手势
        /// </summary>
        ...
        //  public override IHandController HandController { get; set; }

        public MOperate(MInputHand inputHand,Func<bool> func,IHandController handController) : base(inputHand,func,handController)
        {
        ...
        /// 设置物体释放
        /// </summary>
        public override void SetObjectRelease()
        {
        ...
        public override void SetObjectGrab(GameObject target,float zValue)
        {
            //停止手上已经抓取的
            if (OperateObject != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public override GameObject GetObjectGrab()
        {
